...
@section('head')
<title>Parametros algoritmo genetico</title>
@stop

@section('content')
<div class="uk-grid" data-uk-grid-margin>
    <div class="uk-width-1-1">
        <h1 class="uk-h1">Parametros Algoritmo Genetico</h1>
       <blockquote>Cargar paramatros para ejecutar el algoritmo genetico</blockquote>
    </div>
</div>
<br>
<div class="uk-grid ">
    <div class="uk-width-1-1">
		{!! Form::open(array(
                    'action' => 'ParametrosController@genetico',
                    'method' => 'POST',
                    'class' =>  'uk-form',
                    'id' => 'form1'
                            )) 
           ...
           <div class="uk-grid">
                <div class="uk-grid uk-width-1-1">
                    <div class="uk-width-2-6">
                        ...
                        {!! Form::input('text', 'probabilidad_mutacion', Request::old('probabilidad_mutacion'), array('class'=>'uk-width-1-1', 'placeholder'=>'0-1', 'autocomplete' =>'off')) !!}   
                    ...
                    <div class="uk-width-2-6">
                        ...
                        {!! Form::input('text', 'probabilidad_cruce', Request::old('probabilidad_cruce'), array('class'=>'uk-width-1-1', 'placeholder'=>'0-1', 'autocomplete' =>'off')) !!}   
                    ...
                    <div class="uk-width-2-6">
                        ...
                        {!! Form::input('text', 'probabilidad_tabu', Request::old('probabilidad_tabu'), array('class'=>'uk-width-1-1', 'placeholder'=>'0-1', 'autocomplete' =>'off')) !!}   
            ...
            <div class="uk-grid uk-container-center">
                ...
                <div class="uk-width-1-3">
                    <button type="submit" class="uk-button uk-button-primary" data-uk-button><i class="uk-icon-save"></i> Guardar</button>
                </div>           
            </div>

        {!! Form::hidden('_token', csrf_token() ) !!}     
        {!! Form::hidden('genetico') !!}     
...
@section('submenu')
<li class="uk-active"><a href="#"><i class="uk-icon-bar-chart"></i> Agregar configuracion Alg. Genetico</a></li>                                
<li class="uk-nav-header">Operaciones</li>
<li><a href="{{URL::to('listaGenetico')}}"><i class="uk-icon-database"></i> Listas Parametros</a></li>
