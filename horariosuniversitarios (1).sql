...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-07-2015 a las 04:13:05
...
(29, 'Fisica II', '47840121', 4, 4, 2),
(30, 'base datos 1', 'lololppjd', 3, 1, 2),
(31, 'Organizacion del computador', '5454', 4, 1, 2),
(32, 'TGS', 'o747e2', 2, 1, 1);
...
(13, 'Santiago Ramirez', '51565654', 3),
(16, 'Roxana Tiamure', '2232333', 1);
...
(2, 'C04', 'en el C', 1),
(6, '11 B', 'la 11 b queda en el b', 2);
